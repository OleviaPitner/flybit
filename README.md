...
[![Lines](https://img.shields.io/badge/线路类型-IEPL%20全专线-brightgreen.svg)](#)
[![Unlock](https://img.shields.io/badge/解锁支持-Netflix%20%7C%20Disney%2B%20%7C%20ChatGPT-orange.svg)](#)
[![Devices](https://img.shields.io/badge/设备限制-不限客户端与设备数量-blue.svg)](#)
[![Price](https://img.shields.io/badge/起始价格-¥15.00%20%2F%20月-red.svg)](#)
...
```mermaid
flowchart TD
    A[根据需求选择 flybit 套餐] --> B{使用频率与流量}
    B -->|高频日常 / 每月用量固定| C[周期订阅套餐<br/>15元/128G 起，月度重置]
    B -->|低频使用 / 异地备用| D[不限时流量包<br/>36元/128G 起，永久不过期]
    
    C --> C1[日常办公/AI: 128G - 192G]
    C --> C2[重度影音/多设备: 256G - 512G]
```
## 四、 快速上手步骤
...
| 操作系统 | 平台图标 | 推荐客户端列表 |
| :--- | :---: | :--- |
| **Windows** | ![Windows](https://img.shields.io/badge/Windows-0078D6?style=flat-square&logo=windows&logoColor=white) | FlClash、Clash Verge Rev |
| **macOS** | ![macOS](https://img.shields.io/badge/macOS-000000?style=flat-square&logo=apple&logoColor=white) | FlClash、Clash Verge Rev |
| **iOS / iPadOS** | ![iOS](https://img.shields.io/badge/iOS-000000?style=flat-square&logo=apple&logoColor=white) | Shadowrocket、Quantumult X、Surge、Loon |
| **Android** | ![Android](https://img.shields.io/badge/Android-3DDC84?style=flat-square&logo=android&logoColor=white) | FlClash、V2rayNG、Clash Meta for Android |
| **路由器系统** | ![OpenWrt](https://img.shields.io/badge/OpenWrt-001F3F?style=flat-square&logo=openwrt&logoColor=white) | OpenWrt、LEDE |
